    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-3">
          <div class="logo"> <a href="index.html"><img src="{{ asset('frontend/images/logo_wrbt.png') }}" width="200" height="67" alt=""></a> </div>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="single-slide-item-table">
            <div class="single-slide-item-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h2>Selamat Datang di WRBT Consulting</h2>
                    <p>PT Wiru Bati Konsulting atau WRBT Consulting memberikan jasa di bidang: penyusunan laporan keuangan, analisis laporan keuangan, studi kelayakan bisnis dan investasi, pengembangan sistem pengendalian organisasi, pengembangan standard operating procedures, pengembangan organisasi dan sumberdaya manusia, pelatihan profesional, konsultansi manajemen, dan juga perpajakan dan teknologi informasi.</p>
                    <a class="slide-btn" href="javascript:void(0)">contact</a> <a class="slide-btn" href="javascript:void(0)">about</a> </div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="single-slide-item-table">
            <div class="single-slide-item-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h2>WRBT Consulting</h2>
                    <p>motto: "keberhasilan adalah hasil nyata dari profesionalisme."</p>
                    <a class="slide-btn" href="javascript:void(0)">contact</a> <a class="slide-btn" href="javascript:void(0)">about</a> </div>
                </div>
              </div>
            </div>
            ...
            <div class="single-slide-item-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h2>WRBT Consulting</h2>
                    <p>WRBT Consulting memberikan jasa di bidang: penyusunan laporan keuangan, analisis laporan keuangan, studi kelayakan bisnis dan investasi, pengembangan sistem pengendalian organisasi, pengembangan standard operating procedures, pengembangan organisasi dan sumberdaya manusia, pelatihan profesional, konsultansi manajemen, dan juga perpajakan dan teknologi informasi.</p>
                    <a class="slide-btn" href="javascript:void(0)">contact</a> <a class="slide-btn" href="javascript:void(0)">about</a> </div>
                </div>
              </div>
            </div>
